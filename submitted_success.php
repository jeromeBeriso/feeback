                        ...
                        <div class="col-md-6 col-lg-5">
                            <div class="card shadow rounded-4 overflow-hidden">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <!-- Response Message -->
                                    <h6 class="text-success card-footer">Feedback submitted successfully !</h6>
                                    <p class="text-secondary">Thank you for participating on our Feedback Sentiment
                                        Analysis System. Please rest assured that your identity is secure</p>

                                    <!-- Footer with Button -->
                                    <div class="card-footer bg-transparent border-0 mt-2">
                                        <div class="d-flex justify-content-center">
                                            <a href="Feedback.php" class="btn btn-pink px-4">Home</a>
                                        </div>
                                    </div>
