        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 mt-4">
                ...
                <div class="card border-1 shadow mb-4">
                    <div class="card-body">
                        <h5 class="text-primary">Add Faculty</h5>
                        <form id="faculty_form">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="">Name</label>
                                    <input type="text" name="faculty" class="form-control" placeholder="Name">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="">Abbreviations</label>
                                    <input type="text" class="form-control" name="ABV" placeholder="Abbreviations">
                                </div>
                            </div>
                        ...
                        <form id="">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-floating">
                                    <input type="text" name="" class="form-control" id="floatingPassword"
                                        placeholder="Abrev">
