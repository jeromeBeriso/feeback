...
$responseCheck = select("SELECT * FROM feedback WHERE feedback_id = ? AND student_id = ?", [$feedback_id, $student_id], "ii");
                        ...
                        <div class="row">
                            <div class="card border-top-pink border-top">
                                <div class="card-body ">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <span class="badge text-muted bg-white text-wrap">View only </span>
                                    </div>
                                    <footer>
                                        <div class="d-flex card-footer mt-3 justify-content-between">
                                            <h6><?php echo $user_details['name'] ?></h6>
                                            <h6><?php echo $faculty_details['abbrev'] ?></h6>
                                        </div>
                            ...
                            <div class="card mt-3">
                                <div class="card-header d-flex justify-content-between mt-1">
                                    <h6><?php echo $tres['name'] ?></h6>
                                    <h6><?php echo $sres['code'] . '- ' . $sres['name'] ?></h6>
                                </div>
                                <div class="card-body">
                                    <div class="form-floating">
                                        <textarea class="form-control" readonly placeholder="Leave a comment here"
                                            require id="floatingTextarea2"
                                            style="height: 100px"><?php echo $responseData['response'] ?></textarea>
